...
export default function UserDashboard() {
  ...
  return (
    <div className="min-h-screen relative flex flex-col items-center text-white px-4 py-10 overflow-hidden bg-gradient-to-br from-[#1a1a40] via-[#4054b2] to-[#1b1b2f]">
