	...
	return (
		<div className="flex flex-col items-center min-h-screen bg-gradient-to-b from-red-500 to-red-700 text-white py-6">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
							...
							<div className="p-6 bg-gray-50 rounded-xl shadow-lg flex flex-col items-center">
								...
								<div className="text-center">
									...
									<p>
										<strong>Overview:</strong> {eventDetails.overview}
									</p>
								</div>
							</div>
						</div>
			...
			<button
				...
				className="fixed bottom-4 right-4 px-6 py-3 bg-white text-red-500
         font-semibold rounded-full shadow-lg hover:bg-black focus:outline-none focus:ring-2 focus:ring-red-500"
			>
				Logout
			</button>
		</div>
