                ...
                >
                  ...
                  <div className="flex justify-between mt-4">
                    <button
                      ...
                      className="p-3 w-1/2 bg-green-500 text-white rounded-lg shadow-md hover:bg-green-600 transition-colors mx-1"
                    >
                      Accept
                    </button>
                    <button
                      onClick={() => openDeleteModal(user.id)}
                      className="p-3 w-1/2 bg-red-500 text-white rounded-lg shadow-md hover:bg-red-600 transition-colors mx-1"
                    >
                      Remove
                    </button>
                  </div>
